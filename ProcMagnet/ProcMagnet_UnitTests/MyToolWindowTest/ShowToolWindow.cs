...
using Company.ProcMagnet;

namespace ProcMagnet_UnitTests.MyToolWindowTest
{
  [TestClass()]
  public class ShowToolWindowTest
  {
    ...
    {
      IVsPackage package = new ProcMagnetPackage() as IVsPackage;
      ...
      MethodInfo method = typeof(ProcMagnetPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
